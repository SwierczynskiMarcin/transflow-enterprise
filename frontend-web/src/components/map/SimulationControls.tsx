...
export default function SimulationControls() {
    ...
    return (
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-[1000] bg-slate-900/90 backdrop-blur-md rounded-full border border-slate-700 shadow-2xl px-8 py-4 flex items-center gap-8">
            <button
                onClick={togglePlay}
                className="flex items-center justify-center w-14 h-14 bg-cyan-500 hover:bg-cyan-400 text-slate-900 rounded-full transition-colors shadow-[0_0_15px_rgba(34,211,238,0.3)]"
            >
