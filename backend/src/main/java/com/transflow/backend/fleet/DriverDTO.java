...
public record DriverDTO(Long id, Long version, String firstName, String lastName, String phoneNumber, String status, AssignedVehicleDTO assignedVehicle) {
    public record AssignedVehicleDTO(Long id, String plateNumber, String brand) {}

    public static DriverDTO from(Driver d) {
        return new DriverDTO(
                d.getId(), d.getVersion(), d.getFirstName(), d.getLastName(), d.getPhoneNumber(), d.getStatus(),
