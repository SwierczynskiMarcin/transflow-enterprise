...
public record OrderDTO(Long id, LocationDTO startLocation, LocationDTO endLocation, VehicleDTO vehicle, DriverDTO driver, Double cargoWeight, Double pricePerKm, String status, Double progress) {
